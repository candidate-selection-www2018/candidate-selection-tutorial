...
urls = (
    ...
    '/efficientQueryRewritingPage', 'EfficientQueryRewriting',
...
class EfficientQueryRewriting:
    def GET(self):
        return render.efficientQueryRewritingPage()
...
class SearchEntityAwareWithEfficientQuery:
    def GET(self):
        draw, query, offset, count = get_web_input(web_input=web.input())
        return None
